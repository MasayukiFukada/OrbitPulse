...
export const capacities = sqliteTable("capacities", {
  id: text("id").primaryKey(),
  sprintId: text("sprint_id").references(() => sprints.id).notNull(),
...
export const backlogItems = sqliteTable("backlog_items", {
  ...
  status: text("status", { enum: ["backlog", "todo", "doing", "done"] }).default("backlog").notNull(),
...
export const tasks = sqliteTable("tasks", {
  id: text("id").primaryKey(),
  backlogItemId: text("backlog_item_id").references(() => backlogItems.id).notNull(),
  title: text("title").notNull(),
